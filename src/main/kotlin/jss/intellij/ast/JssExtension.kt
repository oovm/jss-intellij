package jss.intellij.ast

import jss.intellij.ide.formatter.JssFormatterContext
import jss.intellij.ide.formatter.JssFormattingModelBuilder
...
private fun jss.intellij.ast.FormatBlock.computeIndent(child: ASTNode): Indent? {
...
fun jss.intellij.ast.FormatBlock.buildChildren(): List<Block> {
