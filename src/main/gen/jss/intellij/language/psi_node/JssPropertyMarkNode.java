...
public class JssPropertyMarkNode extends ASTWrapperPsiElement implements JssPropertyMark {

  public JssPropertyMarkNode(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JssVisitor visitor) {
    visitor.visitPropertyMark(this);
  }
